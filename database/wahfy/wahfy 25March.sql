...
CREATE TABLE `attributes` (
  `id` bigint UNSIGNED NOT NULL,
  `type` enum('size','color') COLLATE utf8mb4_unicode_ci NOT NULL,
...
(5, 'color', 'red', '2021-03-24 12:09:18', '2021-03-24 12:09:18'),
(6, 'color', 'black', '2021-03-24 12:09:29', '2021-03-24 12:09:29');
...
CREATE TABLE `products` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `color` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'black',
  `size` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 's'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `products_attributes` (
  `id` bigint UNSIGNED NOT NULL,
  `arrribute_id` bigint UNSIGNED NOT NULL,
  `product_id` bigint UNSIGNED NOT NULL,
...
ALTER TABLE `products_attributes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `products_attributes_arrribute_id_foreign` (`arrribute_id`),
...
--
ALTER TABLE `products_attributes`
  ADD CONSTRAINT `products_attributes_arrribute_id_foreign` FOREIGN KEY (`arrribute_id`) REFERENCES `attributes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
