...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                <form method="POST" action="{{route('admin.customers.store')}}" id="advanced-form" data-parsley-validate
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="Enter Customer password" name="password"
                                value=""><br>
                            @error('password')
                            <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
