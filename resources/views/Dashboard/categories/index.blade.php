...
<div class="row justify-content-end">
    <div class="col-3">
        <a class="btn btn-round btn-primary buttons-html5"href="{{url('dashboard/categories/create')}}">
                    ...
                    <table class="table table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            ...
                            <td>{{optional($category->industry)->name}}</td>
                                ...
                                <td>
                                    <form action="{{url("/dashboard/categories/{$category->id}")}}" method="post" class="delete" type="submit">
