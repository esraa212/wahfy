...
<body class="theme-blush font-montserrat theme-blush">
    ...
    @include('Dashboard.layout.themesetting')
    ...
    <div id="wrapper">
        ...
        @include('Dashboard.layout.megamenu')
        @include('Dashboard.layout.searchbar')
