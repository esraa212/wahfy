...
@section('title', 'Create Product SubCtategory')
...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>Create New Product SubCategory</h2>
            </div>
            <div class="body">
                <form method="POST" action="{{route('admin.product_subCategories.store')}}" id="advanced-form"
